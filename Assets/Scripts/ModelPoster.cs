...
/// </summary>
public class ModelPoster : MonoBehaviour, IMixedRealityFocusHandler //, IMixedRealityPointerHandler
{
    /*
    ...
    //public void ModelPoster.OnPointerClicked(MixedRealityPointerEventData eventData)
